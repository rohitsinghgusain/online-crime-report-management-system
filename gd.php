                    ...
                    <nav class="py-4">
                      <!--  <div class="logo-w3layouts" id="logo-w3layouts">
                        ...
                        <ul class="menu mt-2">
                            ...
                            <li class="mr-lg-4 mr-3 active"><a href="gd.php" class="scroll">GENERAL DIARIES</a></li>
	...
	<div class="limiter">
		<div class="container-table100" style="background-image:url('page/images/a.jpg');background-size:cover;">
			...
			<div class="wrap-table100">
                ...
                error_reporting(0);
                $query="SELECT complaintNumber,subcategory,complaintDetails,complaintfile FROM tblcomplaints WHERE category='3'";
                ...
                if($total != 0)
                {
                    ...
                    while($result = mysqli_fetch_array($data))
                    {
                      ?>
                        ...
                        <th><?php echo $result[subcategory]; ?></th>
                        <th><?php echo $result[complaintDetails]; ?></th>
                        
                        <th><a href="mwform/gdform.php?uid=<?php echo htmlentities( $result[id]); ?>">Report</th>
                            </tr>
                          <?php 
                    }
                }
