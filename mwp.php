...
<header class="header">
                    ...
                    <nav class="py-4">
                      <!--  <div class="logo-w3layouts" id="logo-w3layouts">
                        ...
                        <ul class="menu mt-2">
                            ...
                            <li class="mr-lg-4 mr-3 active"><a href="mwp.php" class="scroll">MOST WANTED PERSON</a></li>
	...
	<div class="limiter">
		<div class="container-table100" style="background-image:url('page/images/a.jpg');background-size:cover;">
				<h1 class="h">MOST WANTED PERSON</h1>
                ...
                if($total != 0)
                {
                    ...
                    while($result = mysqli_fetch_array($data))
                    {
                      ?>
                        ...
                        <th><?php echo $result[crime]; ?></th> 
                        <th><?php echo $result[cdetails]; ?></th>
                        <th> <img src="admin\image\<?php echo $result[image]; ?>" height="100px" width="100px"></th>
                        <th><a href="mwform/mwpform.php?uid=<?php echo htmlentities( $result[id]); ?>">Report</th>
                            </tr>
                          <?php 
                    }
                }
