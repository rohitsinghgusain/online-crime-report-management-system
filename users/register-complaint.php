...
<label class="col-sm-2 col-sm-2 control-label">Police Station</label>
<div class="col-sm-4">
<select name="psname" required="required" class="form-control">
<option value="">Select Police Station</option>
<?php $sql=mysqli_query($con,"select psname from ps ");
while ($rw=mysqli_fetch_array($sql)) {
  ?>
  <option value="<?php echo htmlentities($rw['psname']);?>"><?php echo htmlentities($rw['psname']);?></option>
<?php
}
?>
