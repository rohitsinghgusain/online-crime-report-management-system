...
$query=mysqli_query($con,"insert into mwform(name,caseno,email,message) values('$name','$caseno','$email','$message')");
// code for show complaint number
$sql=mysqli_query($con,"select id from mwform  order by id desc limit 1");
